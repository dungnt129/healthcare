	...
	<div class="widget-content nopadding">
		...
		<div class="control-group">
			...
			<div class="controls-custom">
                ...
                {!! Form::text("tab[1][tuvanvien1][howManySexFriends]", $user[8]["tuvanvien1"]["howManySexFriends"], ["id" => "tab[1][tuvanvien1][howManySexFriends]"]) !!}
			</div>
			<div class="controls-custom">
                ...
                {!! Form::text("tab[1][tuvanvien1][howManyAssSexFriends]", $user[8]["tuvanvien1"]["howManyAssSexFriends"], ["id" => "tab[1][tuvanvien1][howManyAssSexFriends]"]) !!}
			</div>
			<div class="controls-custom">
