<div class="widget-box">
	<div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
		...
		<div class="span3" style="margin: 3px 0px 0px;float: left;">
			{!! Form::text("tab[{$tab}][tuvanvien1][tentuvanvien]", !empty($user[$index]["tuvanvien1"]["tentuvanvien"]) ? $user[$index]["tuvanvien1"]["tentuvanvien"] : "", ["id" => "tab[{$tab}][tuvanvien1][tentuvanvien]", "class" => "span10", "disabled" => ""]) !!}
		</div>
		<h5>Ngày</h5>
		<div class="span3" style="margin: 3px 0px 0px;float: left;">
			{!! Form::text("tab[{$tab}][tuvanvien1][date]", !empty($user[$index]["tuvanvien1"]["date"]) ? $user[$index]["tuvanvien1"]["date"] : "", ["id" => "tab[{$tab}][tuvanvien1][date]", "class" => "span10 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
		</div>
	</div>
	<div class="widget-content nopadding">
		...
		<div class="control-group">
			...
			<div class="controls-custom">
                ...
                {!! Form::text("tab[{$tab}][tuvanvien1][report_number]", !empty($user[$index]["tuvanvien1"]["report_number"]) ? $user[$index]["tuvanvien1"]["report_number"] : "", ["id" => "tab[{$tab}][tuvanvien1][report_number]", "disabled" => ""]) !!}
			</div>
			<div class="controls-custom">
				<label class="control-sublabel-custom">Con số quan sát được (dựa trên việc đếm số viên còn lại)</label>
                {!! Form::text("tab[{$tab}][tuvanvien1][real_number]", !empty($user[$index]["tuvanvien1"]["real_number"]) ? $user[$index]["tuvanvien1"]["real_number"] : "", ["id" => "tab[{$tab}][tuvanvien1][real_number]", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls-custom">
                ...
                {!! Form::text("tab[{$tab}][tuvanvien1][howManySexFriends]", isset($user[$index]["tuvanvien1"]["howManySexFriends"]) ? $user[$index]["tuvanvien1"]["howManySexFriends"] : "", ["id" => "tab[{$tab}][tuvanvien1][howManySexFriends]", "disabled" => ""]) !!}
			</div>
			<div class="controls-custom">
                ...
                {!! Form::text("tab[{$tab}][tuvanvien1][howManyAssSexFriends]", isset($user[$index]["tuvanvien1"]["howManyAssSexFriends"]) ? $user[$index]["tuvanvien1"]["howManyAssSexFriends"] : "", ["id" => "tab[{$tab}][tuvanvien1][howManyAssSexFriends]", "disabled" => ""]) !!}
			</div>
			<div class="controls-custom">
		...
		<div class="control-group">
			...
			<div class="controls-custom">
				{!! Form::textarea ("tab[{$tab}][tuvanvien1][otherComment]", !empty($user[$index]["tuvanvien1"]["otherComment"]) ? $user[$index]["tuvanvien1"]["otherComment"] : "", ["id" => "tab[{$tab}][tuvanvien1][otherComment]", "class" => "span6", "cols" => "5", "rows" => "5", "disabled" => ""]) !!}
			</div>
		</div>
	</div>
</div>
...
<div class="widget-box">
	<div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
		<h5>Tên bác sĩ</h5>
		<div class="span3" style="margin: 3px 0px 0px;float: left;">
			{!! Form::text("tab[{$tab}][bacsi][tenbacsi]", !empty($user[$index]["bacsi"]["tenbacsi"]) ? $user[$index]["bacsi"]["tenbacsi"]: "", ["id" => "tab[{$tab}][bacsi][tenbacsi]", "class" => "span10", "disabled" => ""]) !!}
		</div>
		<h5>Ngày</h5>
		<div class="span3" style="margin: 3px 0px 0px;float: left;">
			{!! Form::text("tab[{$tab}][bacsi][date]", !empty($user[$index]["bacsi"]["date"]) ? $user[$index]["bacsi"]["date"]: "", ["id" => "tab[{$tab}][bacsi][date]", "class" => "span10 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
		</div>
	</div>
	<div class="widget-content nopadding">
		<!--Bác sĩ form-->
		<div class="control-group">
			...
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][bacsi][fastHIVresult]", !empty($user[$index]["bacsi"]["fastHIVresult"]) ? $user[$index]["bacsi"]["fastHIVresult"] : "", ["id" => "tab[{$tab}][bacsi][fastHIVresult]", "class" => "span2 margin-right5", "placeholder" => "Kết quả", "disabled" => ""]) !!}
				<span>Ngày xét nghiệm</span>
				{!! Form::text("tab[{$tab}][bacsi][fastHIVresultdate]", !empty($user[$index]["bacsi"]["fastHIVresultdate"]) ? $user[$index]["bacsi"]["fastHIVresultdate"] : "", ["id" => "tab[{$tab}][bacsi][fastHIVresultdate]", "class" => "span2 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">2. Kết quả xét nghiệm khẳng định HIV</label>
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][bacsi][confirmHIVresult]", !empty($user[$index]["bacsi"]["confirmHIVresult"]) ? $user[$index]["bacsi"]["confirmHIVresult"] : "", ["id" => "tab[{$tab}][bacsi][confirmHIVresult]", "class" => "span2 margin-right5", "placeholder" => "Kết quả", "disabled" => ""]) !!}
				<span>Ngày xét nghiệm</span>
				{!! Form::text("tab[{$tab}][bacsi][confirmHIVresultdate]", !empty($user[$index]["bacsi"]["confirmHIVresultdate"]) ? $user[$index]["bacsi"]["confirmHIVresultdate"] : "", ["id" => "tab[{$tab}][bacsi][confirmHIVresultdate]", "class" => "span2 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">3. Chức năng thận (độ thanh thải creatinine > 60ml/min) (Các tháng 3,6,12)</label>
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][bacsi][chucnangthanResult]", !empty($user[$index]["bacsi"]["chucnangthanResult"]) ? $user[$index]["bacsi"]["chucnangthanResult"] : "", ["id" => "tab[{$tab}][bacsi][chucnangthanResult]", "class" => "span2 margin-right5", "placeholder" => "Kết quả", "disabled" => ""]) !!}
				<span>Ngày xét nghiệm</span>
				{!! Form::text("tab[{$tab}][bacsi][chucnangthanResultDate]", !empty($user[$index]["bacsi"]["chucnangthanResultDate"]) ? $user[$index]["bacsi"]["chucnangthanResultDate"] : "", ["id" => "tab[{$tab}][bacsi][chucnangthanResultDate]", "class" => "span2 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">4. Bạn có gặp phải các phản ứng phụ không? (Tham khảo phụ lục III)</label>
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][bacsi][hasSideEffects]", !empty($user[$index]["bacsi"]["hasSideEffects"]) ? $user[$index]["bacsi"]["hasSideEffects"] : "", ["id" => "tab[{$tab}][bacsi][hasSideEffects]", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">5. Kết quả xét nghiệm Anti-HCV (Viêm gan C)</label>
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][bacsi][antiHCVresult]", !empty($user[$index]["bacsi"]["antiHCVresult"]) ? $user[$index]["bacsi"]["antiHCVresult"] : "", ["id" => "tab[{$tab}][bacsi][antiHCVresult]", "class" => "span2 margin-right5", "placeholder" => "Kết quả", "disabled" => ""]) !!}
				<span>Ngày xét nghiệm (tháng thứ 12)</span>
				{!! Form::text("tab[{$tab}][bacsi][antiHCVresultdate]", !empty($user[$index]["bacsi"]["antiHCVresultdate"]) ? $user[$index]["bacsi"]["antiHCVresultdate"] : "", ["id" => "tab[{$tab}][bacsi][antiHCVresultdate]", "class" => "span2 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">6. Kết quả xét nghiệm VDRL/RPR (syphilis)</label>
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][bacsi][VDRLRPRresult]", !empty($user[$index]["bacsi"]["VDRLRPRresult"]) ? $user[$index]["bacsi"]["VDRLRPRresult"] : "", ["id" => "tab[{$tab}][bacsi][VDRLRPRresult]", "class" => "span2 margin-right5", "placeholder" => "Kết quả", "disabled" => ""]) !!}
				<span>Ngày xét nghiệm (tháng thứ 12)</span>
				{!! Form::text("tab[{$tab}][bacsi][VDRLRPRresultdate]", !empty($user[$index]["bacsi"]["VDRLRPRresultdate"]) ? $user[$index]["bacsi"]["VDRLRPRresultdate"] : "", ["id" => "tab[{$tab}][bacsi][VDRLRPRresultdate]", "class" => "span2 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">7. Nhiễm độc gan: Mức AST và ALT (tại các tháng 3,6,12)</label>
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][bacsi][poisonGanResult]", !empty($user[$index]["bacsi"]["poisonGanResult"]) ? $user[$index]["bacsi"]["poisonGanResult"] : "", ["id" => "tab[{$tab}][bacsi][poisonGanResult]", "class" => "span2 margin-right5", "placeholder" => "Kết quả", "disabled" => ""]) !!}
				<span>Ngày xét nghiệm</span>
				{!! Form::text("tab[{$tab}][bacsi][poisonGanResultDate]", !empty($user[$index]["bacsi"]["poisonGanResultDate"]) ? $user[$index]["bacsi"]["poisonGanResultDate"] : "", ["id" => "tab[{$tab}][bacsi][poisonGanResultDate]", "class" => "span2 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">8. Các nhận xét khác</label>
			<div class="controls-custom">
				{!! Form::textarea ("tab[{$tab}][bacsi][otherComment]", !empty($user[$index]["bacsi"]["otherComment"]) ? $user[$index]["bacsi"]["otherComment"] : "", ["id" => "tab[{$tab}][bacsi][otherComment]", "class" => "span6", "cols" => "5", "rows" => "5", "disabled" => ""]) !!}
			</div>
		</div>
	</div>
</div>
...
<div class="widget-box">
	<div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
		<h5>Tư vấn viên</h5>
		<div class="span3" style="margin: 3px 0px 0px;float: left;">
			{!! Form::text("tab[{$tab}][tuvanvien3][tentuvanvien]", !empty($user[$index]["tuvanvien3"]["tentuvanvien"]) ? $user[$index]["tuvanvien3"]["tentuvanvien"]: "", ["id" => "tab[{$tab}][tuvanvien3][tentuvanvien]", "class" => "span10", "disabled" => ""]) !!}
		</div>
		<h5>Ngày</h5>
		<div class="span3" style="margin: 3px 0px 0px;float: left;">
			{!! Form::text("tab[{$tab}][tuvanvien3][date]", !empty($user[$index]["tuvanvien3"]["date"]) ? $user[$index]["tuvanvien3"]["date"]: "", ["id" => "tab[{$tab}][tuvanvien3][date]", "class" => "span10 datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
		</div>
	</div>
	<div class="widget-content nopadding">
		<!--Tư vấn viên form-->
		...
		<div class="control-group">
			...
			<div class="controls-custom">
				...
				<label>
					...
					{!! Form::text("tab[{$tab}][tuvanvien3][otherReasonText]", !empty($user[$index]["tuvanvien3"]["otherReasonText"]) ? $user[$index]["tuvanvien3"]["otherReasonText"]:"", ["id" => "tab{$tab}_tuvanvien3_otherReasonText", "class" => "span10", "disabled" => ""]) !!}
				</label>
			</div>
			<div class="controls-custom">
				<label class="control-sublabel-custom">a. Nếu do tác dụng phụ của thuốc, hãy nêu rõ mức độ nào (Xem phụ lục III)</label>
				{!! Form::text("tab[{$tab}][tuvanvien3][sideEffectLevel]", !empty($user[$index]["tuvanvien3"]["sideEffectLevel"]) ? $user[$index]["tuvanvien3"]["sideEffectLevel"]:"", ["id" => "tab[{$tab}][tuvanvien3][sideEffectLevel]", "class" => "span10", "disabled" => ""]) !!}
			</div>
			<div class="controls-custom">
				<label class="control-sublabel-custom">b. Nếu thay đổi nguy cơ, hãy nêu rõ nguy cơ nào và thay đổi thế nào</label>
				{!! Form::text("tab[{$tab}][tuvanvien3][dangerousChange]", !empty($user[$index]["tuvanvien3"]["dangerousChange"]) ? $user[$index]["tuvanvien3"]["dangerousChange"]:"", ["id" => "tab[{$tab}][tuvanvien3][dangerousChange]", "class" => "span10", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">3. Nếu bệnh nhân nhiễm HIV+, hãy ghi ngày làm xét nghiệm định genotype HIV</label>
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][tuvanvien3][HIVdate]", !empty($user[$index]["tuvanvien3"]["HIVdate"]) ? $user[$index]["tuvanvien3"]["HIVdate"]: "", ["id" => "tab[{$tab}][tuvanvien3][HIVdate]", "class" => "datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">4. Nếu bệnh nhân nhiễm HIV+, hãy ghi ngày thực hiện đo nồng độ tenofivir trong máu</label>
			<div class="controls-custom">
				{!! Form::text("tab[{$tab}][tuvanvien3][tenofivirDate]", !empty($user[$index]["tuvanvien3"]["tenofivirDate"]) ? $user[$index]["tuvanvien3"]["tenofivirDate"]: "", ["id" => "tab[{$tab}][tuvanvien3][tenofivirDate]", "class" => "datepicker", "data-date-format" => "dd/mm/yyyy", "disabled" => ""]) !!}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label-custom">5. Các nhận xét khác</label>
			<div class="controls-custom">
				{!! Form::textarea ("tab[{$tab}][tuvanvien3][otherComment]", !empty($user[$index]["tuvanvien3"]["otherComment"]) ? $user[$index]["tuvanvien3"]["otherComment"] : "", ["id" => "tab[{$tab}][tuvanvien3][otherComment]", "class" => "span6", "cols" => "5", "rows" => "5", "disabled" => ""]) !!}
			</div>
		</div>
	</div>
</div>