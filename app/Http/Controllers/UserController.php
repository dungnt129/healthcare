		...
		if (!empty($userId)) {
			...
			$values = [
				[
					...
					'150' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "hasBuonNon"),
					'151' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "hasManNgua"),
					'152' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "hasNonMua"),
					'153' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "howManySexFriends"),
					'154' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "howManyAssSexFriends"),
					'155' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "hasCondomWhenAssSex"),
					'156' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "hasAlwaysUseCondomWhenAssSex"),
					'157' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "hasCocainInLastYear"),
					'158' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien1", "otherComment"),
					'159' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "tenbacsi"),
					'160' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "date"),
					'161' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "fastHIVresult"),
					'162' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "fastHIVresultdate"),
					'163' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "confirmHIVresult"),
					'164' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "confirmHIVresultdate"),
					'165' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "chucnangthanResult"),
					'166' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "chucnangthanResultDate"),
					'167' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "hasSideEffects"),
					'168' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "antiHCVresult"),
					'169' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "antiHCVresultdate"),
					'170' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "VDRLRPRresult"),
					'171' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "VDRLRPRresultdate"),
					'172' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "poisonGanResult"),
					'173' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "poisonGanResultDate"),
					'174' => UserHelper::getShowDataDay234($dataTab4, "bacsi", "otherComment"),
					'175' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "tentuvanvien"),
					'176' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "date"),
					'177' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "hasHIV"),
					'178' => (!empty(UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "otherReason"))) ? UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "otherReason") : UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "otherReasonText"),
					'179' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "HIVdate"),
					'180' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "tenofivirDate"),
					'181' => UserHelper::getShowDataDay234($dataTab4, "tuvanvien3", "otherComment"),
				]
			];
