		...
		if (!empty($userId)) {
			...
			$values = [
				[
					...
					'46' => UserHelper::getShowDataDay1($dataTab1, "tuvanvien1", "email"),
					'47' => UserHelper::getShowDataDay1($dataTab1, "tuvanvien1", "mobile"),
					'48' => (!empty(UserHelper::getShowDataDay1($dataTab1, "tuvanvien1", "howDoYouKnowPrep"))) ? UserHelper::getShowDataDay1($dataTab1, "tuvanvien1", "howDoYouKnowPrep") : UserHelper::getShowDataDay1($dataTab1, "tuvanvien1", "howDoYouKnowPrepText"),
					...
					'56' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "viemGanBresult"),
					'57' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "viemGanBresultdate"),
					'58' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "sangLocViemGanBresult"),
					'59' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "sangLocViemGanBresultdate"),
					'60' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "antiHBsresult"),
					'61' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "antiHBsresultdate"),
					'62' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "antiHCVresult"),
					'63' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "antiHCVresultdate"),
					'64' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "antiHAVresult"),
					'65' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "antiHAVresultdate"),
					'66' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "giangmaiResult"),
					'67' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "giangmaiResultDate"),
					'68' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "chucnangthanResult"),
					'69' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "chucnangthanResultDate"),
					'70' => UserHelper::getShowDataDay1($dataTab1, "bacsi", "otherComment"),
					'71' => UserHelper::getShowDataDay1($dataTab1, "tuvanvien3", "tentuvanvien"),
					'72' => UserHelper::getShowDataDay1($dataTab1, "tuvanvien3", "date"),
					'73' => UserHelper::getShowDataDay1($dataTab1, "tuvanvien3", "accept_prep"),
